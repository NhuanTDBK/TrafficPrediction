...
#                verbose=1,
            ...
            name_file = "ParamsPeriodic/saveNeuralNetwork_%s_%s.tdn" %(item,index)
...
# In[44]:
print "Saving data..."
storeResult["results_nn_periodic"] = pd.DataFrame(list_results,index=list_ninput,columns=learning_rate)
storeResult.close()
# ax = pl.subplot()
